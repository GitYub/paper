...
{{#logList}}
    <tr>
        ...
        <td>
            <button class="btn btn-mini btn-success" type="button" onclick="getid(this)" id="{{id}}">隐藏</button>
        </td>
    </tr>
{{/logList}}
</script>
<script type="text/javascript">
    function getid(obj){
        ...
        var id = obj.id;
        var url = "/sys/paper/disable.json";
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.ret){
                    showMessage("隐藏文件", "成功", true);
                    window.location.reload()
                } else {
                    showMessage("隐藏文件", result.msg, false);
                }
