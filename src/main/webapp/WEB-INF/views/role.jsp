    ...
    <div class="col-sm-9">
        <div class="tabbable" id="roleTab">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a data-toggle="tab" href="#roleAclTab" class="roleTabA">
                        角色与权限
                    </a>
                </li>
                <li>
                    <a data-toggle="tab" href="#roleUserTab" class="roleTabA">
                        角色与用户
                    </a>
                </li>
            </ul>
            <div class="tab-content">
                ...
                <div id="roleUserTab" class="tab-pane fade" >
                    ...
                    <select multiple="multiple" size="10" name="roleUserList" id="roleUserList" style="height: 400px">
                    </select>
...
<script type="text/javascript">
    $(function () {
        ...
        // $("#roleTab .roleTabA").on("shown.bs.tab", function(e) {
        //     console.log("0")
        //     if(lastRoleId == -1) {
        ...
        //     }
        // });
        $("#roleTab .roleTabA").click(function(e){
            if(lastRoleId == -1) {
                showMessage("加载角色关系","请先在左侧选择操作的角色", false);
                return;
            }
